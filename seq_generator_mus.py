...
class Genome():
    ...
    def __init__(self, preload = False):
        self.chromosomes = {}
        self.filename_base = os.path.join(os.path.dirname(__file__), "static/data/GRCm38/ftp.ensembl.org/pub/release-87/fasta/mus_musculus/dna/Mus_musculus.GRCm38.dna.chromosome.{}.fa.gz")
        with open(os.path.join(os.path.dirname(__file__), "static/data/pre_processed/exon_info_mus.p"), "rb") as f:
...
class FastGenome(Genome):
    def sequence(self, gene, exon):
        try:
            ...
            path = os.path.join(os.path.join(os.path.dirname(__file__),'static/data/GRCm38_exons/'), filename)
